...
<body>
    <h1>Halo Admin, Ada pesanan baru masuk!</h1>
    <p>Hi, ada Pesanan Baru yang masuk, kamu bisa melihat dan mengkonfirmasi pesanan dari {{$nama}}, Link untuk konfirmasi pesanan <a href="{{$link}}">Konfirmasi Pesanan</a></p>
   
    <p>Berikut Detail Pesanan dari {{$nama}} </p>
